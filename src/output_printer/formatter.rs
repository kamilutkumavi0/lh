                ...
                for j in 0..self.output_col_vec.len() {
                    if i < self.output_col_vec[j].element_vec.len() {
                        ...
                        match &self.output_col_vec[j].element_vec[i].color {
                            ColorFormat::Black => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    ...
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.black().bold()
                                    ),
                            ...
                            ColorFormat::Red => match &self.output_col_vec[j].element_vec[i].font {
                                FontFormat::Regular => print!(
                                    "{}{}",
                                    space,
                                ...
                                FontFormat::Bold => print!(
                                    "{}{}",
                                    space,
                                    &self.output_col_vec[j].element_vec[i].text.red().bold()
                                ),
                                FontFormat::Italic => print!(
                                    "{}{}",
                                    space,
                                    &self.output_col_vec[j].element_vec[i].text.red().italic()
                                ),
                            },
                            ColorFormat::Green => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    ...
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.green().bold()
                                    ),
                                    FontFormat::Italic => print!(
                                        "{}{}",
                                        space,
                            ...
                            ColorFormat::Yellow => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    ...
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.yellow().bold()
                                    ),
                                    FontFormat::Italic => print!(
                                        "{}{}",
                                        space,
                            ...
                            ColorFormat::Blue => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    ...
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.blue().bold()
                                    ),
                                    FontFormat::Italic => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.blue().italic()
                                    ),
                                }
                            }
                            ColorFormat::Magenta => {
                            ...
                            ColorFormat::Cyan => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    ...
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.cyan().bold()
                                    ),
                                    FontFormat::Italic => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.cyan().italic()
                                    ),
                                }
                            }
                            ColorFormat::White => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    ...
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.white().bold()
                                    ),
                                    FontFormat::Italic => print!(
                                        "{}{}",
                                        space,
                            ...
                            ColorFormat::BrightBlack => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    FontFormat::Regular => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.bright_black()
                                    ),
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                            ...
                            ColorFormat::BrightRed => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    FontFormat::Regular => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.bright_red()
                                    ),
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                            ...
                            ColorFormat::BrightGreen => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    FontFormat::Regular => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.bright_green()
                                    ),
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                            ...
                            ColorFormat::BrightYellow => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    FontFormat::Regular => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.bright_yellow()
                                    ),
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                            ...
                            ColorFormat::BrightBlue => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    FontFormat::Regular => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.bright_blue()
                                    ),
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                            ...
                            ColorFormat::BrightCyan => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    FontFormat::Regular => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.bright_cyan()
                                    ),
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
                            ...
                            ColorFormat::BrightWhite => {
                                match &self.output_col_vec[j].element_vec[i].font {
                                    FontFormat::Regular => print!(
                                        "{}{}",
                                        space,
                                        &self.output_col_vec[j].element_vec[i].text.bright_white()
                                    ),
                                    FontFormat::Bold => print!(
                                        "{}{}",
                                        space,
